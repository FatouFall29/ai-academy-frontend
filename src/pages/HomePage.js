...
<p>Cette section illustre les concepts fondamentaux de React comme les états (state) et les
props.</p>
...
<p>
React utilise un flux de données unidirectionnel : les données descendent de composants
parents
